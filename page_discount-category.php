<?php
/*
 * Template Name: Discount Category
 * Description: Шаблон для категорий скидок.
 */
get_header(); ?>
    <div class="page-wrap">
        <div class="discounts">
            <?php
                ...
                echo "<div class='cat-title'>" . $post->post_title . "</div>";
                $companies = get_page_children( $id, $all_wp_pages );
