...
function twentythirteen_setup() {
    ...
    add_image_size( 'offer-thumb', 490, 350, false );
    add_image_size( 'company-thumb', 400, 200, false ); 
    add_image_size( 'partner-thumb', 220, 90, false ); 
...
function twentythirteen_widgets_init() {
    ...
    register_sidebar( array(
		'name'          => __( 'Woman footer Widget Area', 'twentythirteen' ),
		'id'            => 'woman-sidebar',
		'description'   => __( 'Appears on woman pages in the footer section of the site.', 'twentythirteen' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget'  => '</aside>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
